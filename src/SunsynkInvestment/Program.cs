...
using SunsynkInvestment.Data;
using SunsynkInvestment.Models;
using SunsynkInvestment.Services;
...
var sunsynkSettings = new SunsynkSettings();
config.GetSection("Sunsynk").Bind(sunsynkSettings);
...
Console.WriteLine("Authenticating with Sunsynk...");
var httpClient = new HttpClient();
var apiService = new SunsynkApiService(httpClient, sunsynkSettings);
...
for (var year = startYear; year <= currentYear; year++)
{
    ...
    {
        Console.WriteLine($"Fetching {year} data from Sunsynk API...");
        try
        {
...
Console.WriteLine();
Console.WriteLine("╔══════════════════════════════════════════════════════════════════╗");
Console.WriteLine("║              Sunsynk Solar Investment Report                    ║");
Console.WriteLine("╠══════════════════════════════════════════════════════════════════╣");
Console.WriteLine();
